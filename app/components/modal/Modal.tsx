   ...
   "
      >
        ...
        >
          {/* CONTENT */}
          <div
            className={`transle duration-300 h-full ${
              showModal ? "translate-y-0" : "translate-y-full"
            } ${showModal ? "opacity-100" : "opacity-0"}`}
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounde-lg shadow-lg relative flex flex-col w-full bg-white outyline-none focus:outline-none">
              {/* HEADER */}
              <div
                className="
